...
- 2024.06.04 ~ 2024.07.24
- 매주 수요일 저녁 9시

</details>

2차
- 2024.08.14 ~ 2024.10.02
- 매주 수요일 저녁 9시, 10시
...
#### 2차
- 3명/2명 팀분리 + 1차 인원 1명
- 9시팀 인원 1명이 10시팀 연속해서 진행
- <U>**10시에 5명 전체 모여서 다음주 주제 선정**</U>
  - 기존 스터디와 비슷한 유형의 CS문제
  - 프레임워크 + 언어 관련 문제(하단 질문리스트 중 5개 선택)
  - 기술적인 부분 외의 면접에서 나올만한 질문(예: 프로젝트 진행시 어려웠던점, 집중한부분 등)
- 질문은 각 주제별로 1~2개(질문자 한명당 3~5개의 질문 진행)
- 넓은 범위에 대한 공부보다는 특정 질문에 대한 <span style="color:orange"> **답변 플랜** </span> 준비

<br>

- 각팀 스터디 시간 맞춰서 디스코드 접속
  - 모의면접은 특이사항 없으면 카메라 켜고 진행
  - 돌아가면서 질문자 역할, 질문에 대해 답변자 2명이 각각 순서대로 답변
  - 질문자 차례가 끝나면 답변자 각각에 피드백 전달
  - 질문자 역할 변경 (3회 반복)

- 하루에 1팀, 2팀 2회 진행한 인원은 2팀 잔류
- 2팀 인원 1명은 1팀으로 이동
...
#### 5주차
20) 브라우저의 렌더링 원리에 대해 설명해주세요.
21) Reflow와 Repaint에 대해 설명해주세요.
22) HTML이 렌더링 중에 JavaScript가 실행되면 멈추는데 그 이유는 무엇일까요?
23) React의 라이프 사이클에 대해 설명해주세요.

#### 6주차

24) css - postition 속성에 대해 설명해주세요.
25) 콜백 함수에 대해 설명해주세요.
 - 콜백 지옥을 해결하는 방법을 설명해주세요.
26) 토큰 기반 인증 방식에 대해 설명해주세요.
 - JWT 토큰을 쿠키에 저장했을 때 취약점에 대해 설명해주세요.
27) HTTP와 HTTPS의 차이점에 대해 설명해주세요.


[1~19번 문항 출처](https://zero-base.co.kr/event/media_insight_contents_FE_frontend_tech_Interview)
[20~23번 문항 출처](https://frontend-interview-question.vercel.app/)
[24~27번 문항 출처](https://velog.io/@arthur/%EC%A7%80%EA%B8%88%EA%B9%8C%EC%A7%80-%EB%B0%9B%EC%95%98%EB%8D%98-%EC%8B%A0%EC%9E%85-%ED%94%84%EB%A1%A0%ED%8A%B8%EC%97%94%EB%93%9C-%EB%A9%B4%EC%A0%91-%EC%A7%88%EB%AC%B8%EB%93%A4)
...
## 📘 기술면접 외 질문
- 구체적인 성과 + 기술적 도전, 구체적인 극복사례
- 프로젝트가 실제 환경에서 어떤 영향을 미쳤는지(사용자 경험개선, 성능향상, 비용절감)
- 한문장 or 3~5문장 정도로 답변
...
#### 2주차
1) 가장 큰 기술적 어려움과 해결한 방법
2) 현재 관심을 갖고있는 기술
3) 버그를 찾거나 프로젝트를 테스트하는 자신만의 프로세스

#### 3주차
4) 개발자로서 본인의 약점은 무엇인가요?
5) 프로젝트에서 기술적으로 자랑할만한점

#### 4주차
6) 프로젝트 기획 시 기한은 어떻게 나누는지
7) 프로젝트에서 어떤 개발방식(폭포수, 애자일) 중 어떤걸 써봤는지? 왜 그걸 썼는지?
8) 프로젝트를 개선하려 시도한적이 있는지  

#### 5주차
9) 개발도중 발생하는 에러에 어떻게 대처하는지?
10) 어떻게 프로젝트를 관리했고(스케줄, 소통 등) 어떻게 기여했는가?(문서화, 구조 설계, 개발 등)
11) 새로운 정보의 습득 방법

#### 6주차
12) 프로젝트에서 기술적으로 어려웠던 점과 해결 방법에 대해 설명해주세요.
13) 새로운 기술을 습득하기 위해 어떠한 방식으로 연구하시나요?
14) 최근에 경험했던 기억에 남는 에러에 대해 말씀해주세요.
15) 프로젝트에서 내가 맡은 역할에 대해 설명해주세요
