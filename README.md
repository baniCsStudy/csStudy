...
[1~20번 문항 출처](https://zero-base.co.kr/event/media_insight_contents_FE_frontend_tech_Interview)
...
### 3주차
1) 개발자로서 본인의 약점은 무엇인가요?
2) 프로젝트에서 기술적으로 자랑할만한점

### 4주차
1) 프로젝트 기획 시 기한은 어떻게 나누는지
2) 프로젝트에서 어떤 개발방식(폭포수, 애자일) 중 어떤걸 써봤는지? 왜 그걸 썼는지?
3) 프로젝트를 개선하려 시도한적이 있는지  
